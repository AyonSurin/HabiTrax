...
export type FrameComponentType = {
  materialSymbolscheckCircl?: ImageSourcePropType;
};

const FrameComponent = ({ materialSymbolscheckCircl }: FrameComponentType) => {
  return (
    <View style={styles.androidLarge4Inner}>
      <View style={styles.frameParent}>
        <View style={styles.materialSymbolscheckCircleParent}>
          <Property1DefaultImage
            property1DefaultImageProp={require("../assets/materialsymbolscheckcircleoutlinerounded.png")}
